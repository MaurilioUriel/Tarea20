...
#Solicitar dirección IP o el rango de IPs al usuario
read -p "Introduce la dirección IP o el rango de IPs a escanear: " ip_range

#Solicitar rango de puertos al usuario
read -p "Introduce el rango de puertos a escanear: (p.ej: 1-1000): " port_range
...
echo "Verificando puertos abiertos de netcat..."
